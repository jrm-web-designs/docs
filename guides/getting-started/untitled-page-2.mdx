...
Message was created and is waiting to be processed by a worker.
</Field>

<Field name="queued" type="string">
Message is queued at the SMS provider and will be sent shortly.
</Field>

<Field name="sent" type="string">
Message was successfully sent to the provider. Awaiting delivery confirmation.
</Field>

<Field name="delivered" type="string">
Message was successfully delivered to the recipient's device.
</Field>

<Field name="failed" type="string">
Message delivery failed (e.g., invalid number, carrier rejection, network error).
</Field>

<Field name="blocked" type="string">
Message was blocked by policy (e.g., suppressed recipient, content violation).
</Field>
